...
sub trim($);
my %rank_to_print;
our ($opt_q, $opt_d, $opt_k, $opt_p, $opt_c, $opt_o, $opt_f, $opt_g, $opt_s, $opt_l, $opt_h, $opt_x, $opt_t, $opt_a, $opt_b, $opt_e, $opt_i, $opt_j, $opt_m, $opt_n, $opt_r);

getopts('q:d:kpcofgslhxtabeijmnr');
...
if ($opt_i) {$rank_to_print{suborder} = "1";}
...
print "$numeric_lineage" if $opt_t;
